#!/usr/bin/env python3
"""Phase 10B full: 120-recording O0_4 candidate table + 9 speaker-held-out LR models.

    /home/aaravthegreat/Projects/speechcraft/workers/dataset/.venv/bin/python \\
        scripts/run_phase10b_full.py --workers 2
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Phase 10B logistic full cohort")
    parser.add_argument("--workers", type=int, default=2)
    parser.add_argument(
        "--output-dir",
        default=str(ROOT / "phase10b_logistic_full"),
    )
    ...
    print("phase 10B logistic full passed")
    return 0
